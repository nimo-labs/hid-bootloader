...
/*Packet types */
#define HID_BL_PROTOCOL_PTYPE_GET_VER 0x01
#define HID_BL_PROTOCOL_PTYPE_SEND_VER 0x02
#define HID_BL_PROTOCOL_PTYPE_ACK 0x03
#define HID_BL_PROTOCOL_PTYPE_NAK 0x04
#define HID_BL_PROTOCOL_WRITE_INT_FLASH 0x05
#define HID_BL_PROTOCOL_READ_INT_FLASH 0x06
#define HID_BL_PROTOCOL_VERIFY_INT_FLASH 0x07
#define HID_BL_PROTOCOL_READ_EXT_FLASH 0x08
#define HID_BL_PROTOCOL_WRITE_EXT_FLASH 0x09
#define HID_BL_PROTOCOL_VERIFY_EXT_FLASH 0x0A
#define HID_BL_PROTOCOL_COPY_EXT_TO_INT 0x0B
#define HID_BL_PROTOCOL_RUN_INT 0x0C

#define HID_BL_PROTOCOL_UNSUPPORTED 0xFF
/*******************************************/
